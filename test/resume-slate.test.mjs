...
import { deviceKvGet, deviceKvSet, deviceKvGetJson, deviceKvSetJson } from "../src/core/device-kv.ts";
import { readSlate, setOpened, setRestoreAttempt } from "../src/core/boot/resume-slate.ts";
