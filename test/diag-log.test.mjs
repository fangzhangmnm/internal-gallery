...
import { record, note, entries, clear, toText, initDiagLog } from "../src/core/guards/diag-log.ts";
initDiagLog({ app: "WeebPaint", version: "0.0.0-test" });   // 包化：环境头的 app 名/版本由宿主注入
